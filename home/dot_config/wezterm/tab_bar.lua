...
local RUST_ICON = wezterm.nerdfonts.seti_rust
local RUBY_ICON = wezterm.nerdfonts.seti_ruby
local CPU_ICON = "􀫥 "
...
wezterm.on("format-tab-title", function(tab, tabs, panes, config, hover, max_width)
	...
	elseif exec_name == "rust" or exec_name == "cargo" then
	...
	elseif exec_name == "btop" or exec_name == "top" or exec_name == "htop" then
	...
	elseif exec_name == "ruby" or exec_name == "gem" then
		title_with_icon = RUBY_ICON .. " " .. exec_name
