...
local function get_battery_status()
	for _, b in ipairs(wezterm.battery_info()) do
		if b.state == "Charging" then
			if b.state_of_charge == 1.0 then
				return " " .. wezterm.nerdfonts.md_battery_charging
			end
		end
		...
		if b.state_of_charge >= 0.8 and b.state_of_charge < 0.9 then
			state = "80"
